...
#define CRID_DIROPT_MODELAST	(CRID_DIROPT + 15)
...
#define CRID_SORT_MAX			(CRID_SORTEX + 15)
...
#define CRID_VIEWFORMAT_MAX			(CRID_VIEWFORMATEX + 15)
...
#define CEL(indexNo)  ((ENTRYCELL *)cinfo->e.CELLDATA.p)[((ENTRYINDEX *)cinfo->e.INDEXDATA.p)[indexNo]]
#define CELdata(dataNo) ((ENTRYCELL *)cinfo->e.CELLDATA.p)[dataNo]
#define CELt(indexNo) ((ENTRYINDEX *)cinfo->e.INDEXDATA.p)[indexNo]
